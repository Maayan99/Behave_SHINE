...
class BehaveSHINEDataset(Dataset):
    ...
    Each record has: context (system prompt), question, answer (32B teacher response).
    """
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "answer": item["answer"],
            "difficulty_weight": item.get("difficulty_weight", 1.0),
        }
...
class BehaveSHINECollator:
    ...
    - difficulty_weight                      : per-example loss weights
    """
    ...
    def __call__(self, batch: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "difficulty_weight": torch.tensor(
                [item["difficulty_weight"] for item in batch],
                dtype=torch.float32,
            ),
        }
